...
function videoHTML(token) {
  ...
  return `<div class="video-container">
    <video width="100%" height="100%" preload="metadata" controls>
      <source src="//localhost:4200${src}" ${dataOrigSrcAttr}>
      <a href="//localhost:4200${src}">${src}</a>
    </video>
  </div>`;
}
...
function renderImageOrPlayableMedia(tokens, idx, options, env, slf) {
  ...
  <video hidden id="thumb" controls preload="metadata" width="750px" height="540px">
    <source src="//localhost:4200/uploads/default/original/1X/f654a8514f2880e9205859d90c34ce88246880a4.mp4"
